        ...
        <div>
            ...
            <div className="flex gap-4 bg-[#EBF9FC] border border-solid border-[#98C6CD] rounded-md p-4 items-start mt-4">
              ...
              <div>
                <Text variant="bodyMd" as="p">
                  ...
                  the user is logged in (e.g., Hi Sara), or <b>"Hi there"</b> if
                  they’re not. You can customize what comes after this greeting.
                </Text>
              </div>
            </div>
          ...
          <CollapsibleSection caption="Button Settings">
            <TextField
              ...
              type="text"
              label="Button Label"
              value={form.mainButtonLabel}
              onChange={(e) => setForm({ ...form, mainButtonLabel: e })}
            ...
            <ColorPicker
              onChange={(color) =>
                setForm({ ...form, mainButtonColor: { ...color } })
              }
              color={form.mainButtonColor}
              allowAlpha
            />
          </CollapsibleSection>
        </div>
      ...
      {selectedTab === "intro" && (
        <CollapsibleSection caption="Welcome Message">
          <TextField
            ...
            type="text"
            label="Welcome Message"
            value={form.mainIntroWelcome}
            onChange={(e) => setForm({ ...form, mainIntroWelcome: e })}
          />
        </CollapsibleSection>
      )}
    </div>
